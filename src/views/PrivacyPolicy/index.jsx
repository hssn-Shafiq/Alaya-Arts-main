...
const PrivacyPolicy = () => {
  return (
      ...
      <main>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Alaya Arts.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Alaya Arts, accessible from{" "}
              <a
                href="https://alaya-arts.netlify.app/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://alaya-arts.netlify.app/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: alayaarts@info.com</li>
        </ul>
        </div>
      </main>
