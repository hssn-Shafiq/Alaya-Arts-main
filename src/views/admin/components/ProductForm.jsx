...
const FormSchema = Yup.object().shape({
  ...
  price: Yup.number()
    ...
    .positive("ComparePrice is invalid.")
    .integer("ComparePrice should be an integer.")
    .required("ComparePrice is required."),
              ...
              <div className="d-flex">
                ...
                <div className="product-form-field">
                  <input
                    ...
                    id="unstiched"
                    onChange={(e) =>
                      setValues({ ...values, isUnStiched: e.target.checked })
                    }
                    type="checkbox"
                  />
                  <label htmlFor="unstiched">
                ...
                <div className="product-form-field">
                  <input
                    ...
                    id="accessories"
                    onChange={(e) =>
                      setValues({ ...values, isAccessories: e.target.checked })
                    }
                    type="checkbox"
                  />
