...
import JazzCashPayment from './JazzCashPayment'; // Import the new component
...
const Payment = ({ shipping, payment, subtotal }) => {
  useDocumentTitle('Check Out Final Step | Alaya Arts');
  useScrollTop();
      ...
      >
        {() => (
          <Form className="checkout-step-3">
            <CreditPayment />
            <PayPalPayment />
            <JazzCashPayment /> {/* Include the new component */}
            <Total
