  ...
  return (
    <>
      ...
      <main className='content'>
        <div className="main p-2 p-md-5">
          <h1 className="text-center fw-bold">ABOUT US</h1>
          <img src={img1} alt="Alaya Arts" className="main-image" />
          <p>
            ...
            than 250,000 customers nationwide.
          </p>
          <h3>OUR PROMISE</h3>
          <p>
          ...
          <img src={img2} alt="Our Promise" className="main-image" />
          <p>
          ...
          <img src={img4} alt="Our Promise" className="main-image" />
          ...
          <img src={img3} alt="Shop Now" className="main-image" />
          <p>
